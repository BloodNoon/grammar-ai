...
const PronounSentenceBuilder = ({ 
  ...
  const getWordTypeColor = (type) => {
    const colorMap = {
      ...
      'Possessive' :'green.500',   // Green for determiners (articles) - primary focus
      'Reflexive' : 'orange.500',    // Orange for adjectives
  ...
  const getWordTypeBackgroundColor = (type) => {
    const backgroundMap = {
      ...
      'Possessive': 'green.50',   // Light green for articles - primary focus
      'Reflexive': 'orange.50',    // Light orange
