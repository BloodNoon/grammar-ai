...
import { PageContainer, GameCard, LessonIntroCard } from "../components/ui";
        ...
        <VStack spacing={6} align="stretch">
          <GameCard variant="game" bg="gray.50">
            <Heading size="md" color="ink.700" mb={4}>
              📹 Today's Lesson: Article Sentence Structures
            </Heading>
            <Box
              position="relative"
              w="100%"
            ...
            >
              ...
              >
                <source src="/article-sentence-structures.mp4" type="video/mp4" />
