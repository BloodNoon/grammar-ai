...
const AdverbPractice = () => {
  const typingQuestions = adverbData.filter(
    (q) => q.practice_type === "typing",
  );
  const mcQuestions = adverbData.filter(
  ...
  return (
    <PageContainer>
      ...
      <GameCard mb={8} textAlign="center" bg="brand.500" display="none">
        <Heading size="xl">🎯 Adverb Practice Games</Heading>
        ...
        <VStack spacing={6} align="stretch">
          ...
          <GameCard variant="game">
            <Heading size="md" color="green.500" mb={4}>
              📝 Adverb Identification Challenge
            </Heading>
