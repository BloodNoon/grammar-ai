...
const AdverbPractice = () => {
  ...
  const games = [
    {
      id: "mc",
      title: "📝 Adverb Identification Challenge",
      color: "green.500",
      component: <MultipleChoiceWrapper questionsToPlay={mcQuestions} nextPath="/adverb-structure" />,
    },
    {
      id: "typing",
      title: "✍️ Typing Challenge",
      color: "purple.500",
      component: <TypingGameWrapper questionsToPlay={typingQuestions} nextPath="/adverb-structure" />,
    },
    {
      id: "hunt",
      title: "🔍 Adverb Hunt",
      color: "yellow.500",
      component: <AdverbHuntGame />,
    },
  ];
        ...
        {completed ? (
          <GameCard variant="game" textAlign="center" py={12}>
            ...
            <Heading size="lg" color="ink.700" mb={3}>
              You've completed all the Adverb games!
            </Heading>
            <Text fontSize="md" color="gray.600" mb={6}>
              Great work mastering adverbs through Multiple Choice, Typing,
              and Adverb Hunt.
            </Text>
            <Box
              as="button"
