...
const AdverbPractice = () => {
  const sortingQuestions = adverbData.filter((q) => q.practice_type === "sorting");
  ...
  const games = [
    { id: "mc", title: "📝 Adverb Identification Challenge", color: "green.500", component: <MultipleChoiceWrapper questionsToPlay={mcQuestions} nextPath="/adverb-structure" /> },
    { id: "typing", title: "✍️ Typing Challenge", color: "purple.500", component: <TypingGameWrapper questionsToPlay={typingQuestions} nextPath="/adverb-structure" /> },
    { id: "sorting", title: "🔀 Adverb Sorting", color: "#FF5722", component: <SortingGameWrapper questionsToPlay={sortingQuestions} nextPath="/adverb-structure" /> },
  ...
  return (
    <PageContainer>
      <LessonPageHeader icon="🎯" title="Adverb Practice Games" />
      <Box maxW="800px" mx="auto">
        {completed ? (
          <GameCard variant="game" textAlign="center" py={12}>
            <Text fontSize="4xl" mb={3}>🏆</Text>
            <Heading size="lg" color="ink.700" mb={3}>You've completed all the Adverb games!</Heading>
            <Text fontSize="md" color="gray.600" mb={6}>Great work mastering adverbs through Multiple Choice, Typing, Sorting, and AI Practice.</Text>
          ...
          <GameCard variant="game">
            ...
            {isAI ? (
              <GrammarAIPractice topic="adverbs" onComplete={handleNext} />
            ) : (
              <>
                {current.component}
