...
function getWordType(word) {
  ...
  const adjectives = ['big', 'small', 'red', 'blue', 'happy', 'sad', 'quick', 'slow', 'beautiful', 'ugly', 'old', 'new', 'tall', 'short', 'fast', 'interesting'];
  const nouns = ['dog', 'cat', 'house', 'car', 'book', 'tree', 'ball', 'bird', 'fish', 'apple', 'cats', 'dogs', 'children', 'dinner', 'work', 'ice', 'music', 'food', 'elephant', 'umbrella', 'orange', 'university', 'room', 'table', 'chair', 'window', 'door', 'garden', 'flower', 'student', 'teacher', 'computer'];
  const verbs = ['cleaned', 'saw', 'bought', 'found', 'read', 'opened', 'closed', 'watched', 'heard', 'ate', 'drank', 'painted', 'fixed', 'built', 'run', 'jump', 'eat', 'sleep', 'play', 'sing', 'dance', 'walk', 'fly', 'swim'];
...
const ArticleStructure = () => {
  ...
  const articleWordBank = {
    ...
    Adjective: ['big', 'small', 'red', 'blue', 'happy', 'beautiful', 'old', 'new', 'tall', 'short', 'fast', 'interesting'],
    Noun: ['dog', 'cat', 'house', 'car', 'book', 'tree', 'ball', 'bird', 'fish', 'apple', 'cats', 'dogs', 'children', 'room', 'table', 'chair', 'window', 'door', 'garden', 'flower', 'student', 'teacher', 'computer', 'elephant', 'umbrella', 'orange', 'university'],
    Verb: ['cleaned', 'saw', 'bought', 'found', 'read', 'opened', 'closed', 'watched', 'heard', 'ate', 'drank', 'painted', 'fixed', 'built'],
    Conjunction: ['and', 'or']
  };
  ...
  const generateArticleWordSetFromTestCases = () => {
    ...
    const combinedWords = [...new Set([...words, ...Object.values(articleWordBank).flat().slice(0, 10)])];
      ...
      if (isStructureValid && hasArticles) {
        for (let i = 0; i < sentenceArea.length - 1; i++) {
          ...
          if (currentWord.type === 'Determiner') {
            // Check a/an usage
            if (currentWord.text.toLowerCase() === 'a' && nextWord.text.match(/^[aeiou]/i)) {
              isStructureValid = false;
              break;
            }
            if (currentWord.text.toLowerCase() === 'an' && !nextWord.text.match(/^[aeiou]/i)) {
              isStructureValid = false;
              break;
            }
          }
  ...
  // ===== LESSON INTERACTION =====
  const handleArticleSentenceChoice = (sentenceNum, chosenSentence, isCorrect) => {
    let feedbackText = '';
    let color = '';
      ...
      <div style={styles.container}>
        ...
        <div style={styles.mainContent}>
          ...
          <div>
            ...
            {/* Bottom Left - Articles Typing Challenge */}
          ...
          <div>
            ...
            <div style={{
              ...
              <p style={{
                ...
                Watch this lesson to understand articles and sentence building:
              </p>
              <div style={{
                position: 'relative',
                width: '100%',
            ...
            <div style={styles.panel}>
              ...
              <ArticleActionButtons 
                ...
                generateArticleWordSetFromTestCases={generateArticleWordSetFromTestCases}
                sentenceArea={sentenceArea}
                isCompleted={isCompleted}
              />

              <ArticleFeedbackDisplay 
                feedback={feedback}
              />
            </div>
          </div>
