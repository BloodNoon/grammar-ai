...
const PrepositionPractice = () => {
  ...
  const games = [
    {
      id: "mc",
      title: "📝 Preposition Identification Challenge",
      color: "green.500",
      component: <MultipleChoiceWrapper questionsToPlay={mcQuestions} nextPath="/prep1-structure" />,
    },
    {
      id: "typing",
      title: "✍️ Typing Challenge",
      color: "purple.500",
      component: <TypingGameWrapper questionsToPlay={typingQuestions} nextPath="/prep1-structure" />,
    },
    {
      id: "hunt",
      title: "🔍 Preposition Hunt",
      color: "yellow.500",
      component: <PrepositionHuntGame />,
    },
  ];
        ...
        {completed ? (
          <GameCard variant="game" textAlign="center" py={12}>
            ...
            <Heading size="lg" color="ink.700" mb={3}>
              You've completed all the Preposition games!
            </Heading>
            <Text fontSize="md" color="gray.600" mb={6}>
              Great work mastering prepositions through Multiple Choice, Typing,
              and Preposition Hunt.
            </Text>
            <Box
              as="button"
