...
const PrepositionPractice = () => {
  const typingQuestions = prepositionData.filter(
    (q) => q.practice_type === "typing",
  );
  const mcQuestions = prepositionData.filter(
  ...
  return (
    <PageContainer>
      ...
      <GameCard mb={8} textAlign="center" bg="brand.500" display="none">
        <Heading size="xl">🎯 Preposition Practice Games</Heading>
        ...
        <VStack spacing={6} align="stretch">
          ...
          <GameCard variant="game">
            ...
            <Text fontSize="md" color="gray.600" mb={6}>
              Master your preposition knowledge through three different
