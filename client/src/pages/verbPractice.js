...
const VerbPractice = () => {
  ...
  const games = [
    { id: "mc", title: "📝 Verb Identification Challenge", color: "green.500", component: <MultipleChoiceWrapper questionsToPlay={mcQuestions} nextPath="/verb-tense-structure" /> },
    { id: "typing", title: "✍️ Typing Challenge", color: "purple.500", component: <TypingGameWrapper questionsToPlay={typingQuestions} nextPath="/verb-tense-structure" /> },
    { id: "sorting", title: "🔀 Verb Sorting", color: "#FF5722", component: <SortingGameWrapper questionsToPlay={sortingQuestions} nextPath="/verb-tense-structure" /> },
      ...
      <Box maxW="800px" mx="auto">
        {completed ? (
          <GameCard variant="game" textAlign="center" py={12}>
            ...
            <Heading size="lg" color="ink.700" mb={3}>You've completed all the Verb games!</Heading>
            <Text fontSize="md" color="gray.600" mb={6}>Great work mastering verbs through Multiple Choice, Typing, Sorting, and AI Practice.</Text>
          ...
          <GameCard variant="game">
            ...
            {isAI ? (
              <GrammarAIPractice topic="verb_tenses" onComplete={handleNext} />
            ) : (
              <>
                {current.component}
