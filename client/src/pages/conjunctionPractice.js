...
const ConjunctionPractice = () => {
  const sortingQuestions = conjunctionData.filter((q) => q.practice_type === "sorting");
  ...
  const games = [
    { id: "mc", title: "📝 Conjunction Identification Challenge", color: "green.500", component: <MultipleChoiceWrapper questionsToPlay={mcQuestions} nextPath="/conjunction-structure" /> },
    { id: "typing", title: "✍️ Typing Challenge", color: "purple.500", component: <TypingGameWrapper questionsToPlay={typingQuestions} nextPath="/conjunction-structure" /> },
    { id: "sorting", title: "🔀 Conjunction Sorting", color: "#FF5722", component: <SortingGameWrapper questionsToPlay={sortingQuestions} nextPath="/conjunction-structure" /> },
      ...
      <Box maxW="800px" mx="auto">
        {completed ? (
          <GameCard variant="game" textAlign="center" py={12}>
            ...
            <Heading size="lg" color="ink.700" mb={3}>You've completed all the Conjunction games!</Heading>
            <Text fontSize="md" color="gray.600" mb={6}>Great work mastering conjunctions through Multiple Choice, Typing, Sorting, and AI Practice.</Text>
          ...
          <GameCard variant="game">
            ...
            {isAI ? (
              <GrammarAIPractice topic="conjunctions" onComplete={handleNext} />
            ) : (
              <>
                {current.component}
