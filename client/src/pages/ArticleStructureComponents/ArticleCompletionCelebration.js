...
const ArticleCompletionCelebration = ({ 
  ...
  return (
    ...
    <div style={{ 
      ...
      <p style={{ 
        ...
        You've successfully built <strong>{correctCount}</strong> correct sentences with proper articles!
      </p>
      ...
      <div style={{
        ...
        Ready to master articles again? Challenge yourself with new sentences!
      </div>
    </div>
  );
};

export default ArticleCompletionCelebration;