...
// This component displays progress toward the goal of 10 correct article sentences with detailed statistics
...
const ArticleProgressTracker = ({ 
  ...
  return (
    ...
    <Box style={{ textAlign: 'left' }}>
      ...
      <Heading as="h3" size="md">{isCompleted ? 'Articles Challenge Completed!' : 'Articles Progress Tracker'}</Heading>
