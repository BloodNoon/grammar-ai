...
const VerbActionButtons = ({ 
  ...
  generateVerbWordSetFromTestCases, // Function to generate new word set
  ...
  return (
    ...
    <Box style={{ 
      ...
      <Box style={{
        ...
        <Button 
          onClick={generateVerbWordSetFromTestCases}
          disabled={isCompleted} // Disable when challenge is completed
          sx={{
        ...
        <Box style={{
          ...
          <Box style={{
            ...
            <Box sx={{ color: 'gray.500' }}>
              Validates your sentence structure and verb tenses. Only works when you have words in your sentence.
            </Box>
          </Box>
...
export default VerbActionButtons;