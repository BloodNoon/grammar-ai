...
// This component allows users to choose target sentence structures for focused verb tense practice
import React from 'react';

const VerbStructureSelection = ({ 
  verbStructureExamples, // Array of available sentence structure patterns with examples
  ...
  return (
    ...
    <Box sx={{ 
      ...
      <Heading as="h3" size="md" sx={{ 
        ...
        Choose a Verb Structure to Practice (Optional)
      </Heading>
      ...
      <Text sx={{
        ...
        Select a specific sentence pattern to focus your practice, or leave unselected for free-form building.
      </Text>
...
export default VerbStructureSelection;