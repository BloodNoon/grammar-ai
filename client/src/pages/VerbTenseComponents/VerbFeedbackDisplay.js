    ...
    <Box style={{
      ...
      {feedbackType === 'success' && feedback.includes('/10') && (
        <Box style={{
          ...
          {feedback.match(/(\d+)\/(\d+)/g) && (
            <Box>
              Keep going! You're doing great with verb tense practice! 🚀
            </Box>
          )}
        </Box>
      )}
      ...
      {feedback.includes('CONGRATULATIONS') && feedback.includes('10 correct') && (
        <Box style={{
          ...
          <Box>You've mastered verb tense sentence building!</Box>
      ...
      {feedbackType === 'error' && (
        <Box style={{
          ...
          💡 Try focusing on auxiliary verbs and verb tense consistency
        </Box>
      )}
      ...
      {feedbackType === 'warning' && (
        <Box style={{
          ...
          📚 Take your time and remember the verb tense patterns from the lesson above!
        </Box>
      )}
...
export default VerbFeedbackDisplay;