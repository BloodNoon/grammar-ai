...
const VerbCompletionCelebration = ({ 
  ...
  return (
    ...
    <div style={{ 
      ...
      <p style={{ 
        ...
        You've successfully built <strong>{correctCount}</strong> correct verb sentences!
      </p>
      ...
      <div style={{
        ...
        Ready to master verb tenses again? Challenge yourself with new sentences!
      </div>
    </div>
  );
};

export default VerbCompletionCelebration;