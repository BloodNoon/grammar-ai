...
const SortingGameWrapper = ({ questionsToPlay, nextPath }) => {
  ...
  const startNewGame = () => {
    // 1. Shuffle and take exactly 15 questions from the passed-in JSON
    ...
    <Box maxW="1000px" mx="auto" p={6} fontFamily="'Inter', sans-serif">
      ...
      <Box mb={8} p={4} bg="white" borderRadius="xl" border="3px solid #1A1A1A" boxShadow="4px 4px 0px #1A1A1A">
        <Flex justify="space-between" mb={2}>
          <Text fontWeight="bold" color="#1A0933">Mastery Progress</Text>
          <Text fontWeight="bold" color="#1A0933">
